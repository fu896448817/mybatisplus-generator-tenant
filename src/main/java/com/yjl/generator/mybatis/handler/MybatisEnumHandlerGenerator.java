package com.yjl.generator.mybatis.handler;
...
public class MybatisEnumHandlerGenerator {
    ...
    // 枚举包位置 :
    // /Users/pijingzhanji/Desktop/aidijing/aidijing-dao/target/classes/com/aidijing/domain/enums/
    private static final String ENUM_PACKAGE_FILE_PATH = "";
    // 枚举包名称 : com.aidijing.domain.enums
    private static final String ENUM_PACKAGE_PATH = "";
    private static final String HANDLER_PACKAGE_FILE_PATH = "com.yjl.bean.handler";

    @Test
    public void mybatisEnumHandlerGeneratorExecute() throws Exception {
        // 得到枚举包目录
        // /Users/pijingzhanji/Desktop/aidijing/aidijing-dao/target/classes/com/aidijing/domain/enums
        File enumPackage = new File(ENUM_PACKAGE_FILE_PATH);
        // 枚举处理器包位置
        // /Users/pijingzhanji/Desktop/aidijing/aidijing-dao/target/classes/com/aidijing/handler/
        ...
        if (enumPackage.isDirectory() && ArrayUtils.isNotEmpty(enumPackage.listFiles())) {
            ...
            for (File file : enumPackage.listFiles()) {
                ...
                this.mybatisEnumHandlerGenerator(context, templatePath,
                        handlerPackage.replace("target/classes", "src/main/java") + enumHandlerName
                                + ".java");
            }
        }
    ...
    private void mybatisEnumHandlerGenerator(VelocityContext context, String templatePath,
