...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                // 全局配置
                new GlobalConfig().setOutputDir(output)// 输出目录
        ...
        // .setControllerName("%sAction")
                ...
                new DataSourceConfig().setDbType(DbType.MYSQL)// 数据库类型
                        ...
                        .setUrl("jdbc:mysql://101.200.173.33:3306/crm_demo?characterEncoding=utf8") // TODO
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                        // .setCapitalMode(true)// 全局大写命名
                        // .setDbColumnUnderline(true)//全局下划线命名
                        .setTablePrefix(new String[] {"manager_"})// 此处可以修改为您的表前缀 TODO
                ...
                .setPackageInfo(
                        ...
                        new PackageConfig()
                                // .setModuleName( "test" )
                                .setParent("com.amily.crm")// 自定义包路径 // TODO
                ...
                .setCfg(
                        ...
                        new InjectionConfig() {
                            ...
                            public void initMap() {
                                ...
                                Arrays.asList(new FileOutConfig("/templates/mapper.xml.vm") {
                                    // 自定义输出文件目录
                                    @Override
                                    public String outputFile(TableInfo tableInfo) {
                                        return output + tableInfo.getEntityName() + ".xml";
                                    }
                                })))
                .setTemplate(
